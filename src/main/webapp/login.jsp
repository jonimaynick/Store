<%-- 
    Document   : login
    Created on : Jun 21, 2022, 2:07:30 AM
    Author     : PC
--%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="mainPage">
                <%
                    String errorMessage = (String) session.getAttribute("ERROR-INCORRECT");
                    if (errorMessage != null) {
                %>
                <a style="color: red; font-weight: bold; font-size: 25px"><%=errorMessage%></a>
                <%
                    }
                %>
                <h1>Login User</h1>
                <form action="MainController" method="POST">
                    ...
                    <div id="button">
                        ...
                        <a id="note">If you don't have account, sign up to get account</a>
                        </br>
                        <a id="signUp" href="createUser.jsp">Sign Up</a>
                    </div>
