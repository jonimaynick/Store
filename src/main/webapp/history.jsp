<%-- 
    Document   : history
    Created on : Jun 21, 2022, 11:31:39 AM
    Author     : PC
--%>

<%@page import="phu.DAO.OrderDAO"%>
<%@page import="phu.DTO.OrderDTO"%>
        ...
        <div class="container">
            ...
            <div class="mainPage">
                <%
                    ...
                    List<OrderDTO> listt = orderDao.GetListOrder(user.getUserID());
                    if (listt == null || listt.isEmpty()) {
                %>
                <h1>Your have not buy yet!</h1>
                <%
                } else {
                    for (OrderDTO dto : listt) {
                %>

                <div id="history">
                    <a>Order ID: <%=dto.getOrderID()%></a>
                    <a>Order Date: <%=dto.getOrderDate().toString()%></a>
                    <a>Order Total: <%=dto.getTotal()%></a>
                    <a>Coupons: <%=dto.getCouponsCode()%></a>
