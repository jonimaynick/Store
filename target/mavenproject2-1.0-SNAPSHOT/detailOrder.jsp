<%-- 
    ...
    Created on : Jun 21, 2022, 11:46:27 AM
    Author     : PC
--%>

<%@page import="phu.DAO.DetailDAO"%>
<%@page import="phu.DTO.BookHistoryDTO"%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="mainPage">
                <%
                    List<BookHistoryDTO> list = (List<BookHistoryDTO>) request.getAttribute("LIST");
                ...
                <table border="1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%=dto.getId()%></td>
                            <td><%=dto.getTitle() %></td>
                            <td><img src="<%=dto.getImage()%>" width="100" height="150"></td>
