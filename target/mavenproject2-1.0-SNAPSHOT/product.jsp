<%-- 
    Document   : product
    Created on : Jun 21, 2022, 2:09:32 AM
    Author     : PC
--%>
...
<html>
    <head>
        ...
        <link href="pro2.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="container">
            ...
            <div class="mainPage">
                ...
                <div id="main-information">
                    <div id="image-book">
                        <img src="<%=book.getImage()%>" width="400" height="500"/>
                    </div>
                    <div id="book-information">
                        <a id="title"><%=book.getTitle()%></a><br><br>
                        <a id="price"><%=book.getPrice()%> $</a>
                        <div id="buy-product">
                            <form action="MainController">
                                <input type="number" name="QUANTITY" value="1"  min="1"  style="width: 50px; margin: 5px auto; " /><br>                                
                                <%if (user == null || user.getRoleName().equals("USER")) {
                                %>
                ...
                <div id="product-describe">
                    <h3>Book Describe</h3><br>
                    <a><%=book.getDescribe()%></a>
                </div>
                <div id="review">
