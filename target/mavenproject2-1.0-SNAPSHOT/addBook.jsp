<%-- 
    Document   : addBook
    Created on : Jun 21, 2022, 2:03:11 AM
    Author     : PC
--%>
...
<html>
    ...
    <body>
            ...
            %>
            <h1 style="margin: 10px 400px;">Add Book</h1>
            <div class="main-add">
                <form action="MainController" method="POST">
                    <label>Title</label>
                    <input type="text" name="txtTitle" value="" required="true" minlength="5" maxlength="100"/><br>
                    <br>
                    <label>Price</label>
                    <input type="number" name="numberPrice" value="" required="true" min="1"/><br>
                    <br>
                    <label>Image</label>
                    <input type="text" name="txtImage" value="" required="true"/><br>
                    <br>
                    <label>Describe</label>
                    <input type="text" name="txtDescribe" value="" required="true" minlength="5" maxlength="1000"/><br>
                    <br>
                    <label>Author</label>
                    <input type="text" name="txtAuthor" value="" required="true" minlength="5" maxlength="100"/><br>
                    <br>
                    <label>Category</label>
                    <input type="text" name="txtCategory" value="" required="true" list="category" /><br>
                    <datalist id="category">
                        <%
                            BookDAO daoBook = new BookDAO();
                            List<String> list = daoBook.getListCategory();
                            for (String d : list) {
                        %>
                        <option value="<%=d%>">
                            <%
                    ...
                    <input type="number" name="numberQuantity" value="" required="true" min="1"/> <br>  
                    <br>
